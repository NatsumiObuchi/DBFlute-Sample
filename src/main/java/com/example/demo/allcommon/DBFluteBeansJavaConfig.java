package com.example.demo.allcommon;
 ...
 */
@Configuration
@ComponentScan(value="com.example.demo.exbhv", lazyInit=true)
public class DBFluteBeansJavaConfig {
    ...
    public DBFluteInitializer createDBFluteInitializer() { // no lazy for initialize-only component
        return new com.example.demo.allcommon.DBFluteInitializer(_dataSource);
    }
    ...
    protected ImplementedInvokerAssistant newImplementedInvokerAssistant() {
        return new com.example.demo.allcommon.ImplementedInvokerAssistant();
    }
